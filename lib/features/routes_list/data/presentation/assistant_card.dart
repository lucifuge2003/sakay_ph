...
class _AssistantPopupState extends State<AssistantPopup> {
  ...
  final Map<String, Map<String, String>> jeepneyRoutes = {
    ...
    'marisol-pampang': {
      ...
      'drops':
          'Marisol, Pampang Terminal, Angeles City Proper, Mugs and Magic, Marisol Gate 2',
    },
    'Villa-Pampang': {
      'desc':
          'Connects Villa Angela subdivision to Pampang. Popular among commuters heading to local schools.',
      'drops':
          'Holy Angel University, Pampang Market, Pandan Road, SM Telebastagan, Nepo Mall',
    },
    'capaya': {
      'desc':
          'Capaya route services Capaya and nearby barangays, connecting them to downtown Angeles.',
      'drops':
          'Capaya, Holy Family Academy, Angeles City Hall, City Center Subdivision, Hi-Precision Diagnostic',
    },
    'sapangbato': {
      'desc':
          'Sapangbato route travels from downtown to the Sapangbato area near Clark Freeport.',
      'drops':
          'Sapangbato, Friendship, Checkpoint, Coffee Bay, Porac Intersection',
    },
    'carmenville': {
      'desc':
          'Carmenville route covers major residential zones with access to Clark area and Nepo Center.',
      'drops':
          'Carmenville, Nepo Center, Marquee Mall, Circuit people Gym, Coffee Cat',
    },
    'pandan': {
      'desc':
          'Pandan jeepneys travel from the northern side of Angeles City to the market area.',
      'drops':
          'Pandan, Nepo Mart, Angeles City Hall, Hi-Precicion Medical Center',
    },
    'checkpoint-balibago': {
      'desc':
    ...
    'mining': {
      ...
      'drops':
          'Mining, Checkpoint, Holy Rosary Parish, Holy Angel University, Nepo Mart',
    },
  };
